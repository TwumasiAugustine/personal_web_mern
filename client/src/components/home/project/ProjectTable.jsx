				...
				<tbody>
					{projects.map((project, index) => (
						<tr
							...
							<td className='px-4 text-sm lg:text-lg sm:text-xs py-2'>{project.title}</td>
							<td className='px-4 text-sm lg:text-lg sm:text-xs py-2'>
								<a
									href={project?.url}
									className='text-blue-600 capitalize hover:underline'
									target='_blank'>
									{getDomainName(project?.url)}
								</a>
							</td>
